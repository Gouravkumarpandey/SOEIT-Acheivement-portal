...
const styles = StyleSheet.create({
  ...
  logoBadge: { width: 44, height: 44, borderRadius: 12, backgroundColor: '#ffffff', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#e2e8f0', elevation: 2, shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 5 },
  ...
  primaryBtn: { flex: 1.5, borderRadius: 16, overflow: 'hidden', elevation: 12, shadowColor: COLORS.primary, shadowOpacity: 0.3, shadowOffset: { width: 0, height: 8 }, shadowRadius: 12 },
  ...
  gazetteCard: { backgroundColor: '#fffdf9', borderRadius: 8, padding: 25, borderWidth: 1, borderColor: '#ece7db', shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 15, elevation: 4, minHeight: 180 },
